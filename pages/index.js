        ...
        <Root>
            ...
            <Section>
                <div className="text-center">
                    ...
                    <h2 className="my-6 text-5xl font-bold">
                        Learn by <TextGradient gradient="from-blue-500 to-green-300">doing stuff.</TextGradient>
                    </h2>
            ...
            <Section className="mt-10">
                <div className="text-center">
                    ...
                    <h2 className="my-6 text-5xl font-bold">
                        Work with our <TextGradient gradient="from-orange-500 to-yellow-300">awesome team.</TextGradient>
                    </h2>
                    <p className="text-gray-500 max-w-2xl text-xl mx-auto">
                        Doing stuff alone is lame. Collaborate with your peers and our officers to make events happen, participate in national competitions, and have fun!
                    </p>
                </div>
            ...
            <Section className="mt-10">
                <div className="text-center">
                    ...
                    <p className="text-gray-500 text-xl">You're in good hands. Promise.</p>
